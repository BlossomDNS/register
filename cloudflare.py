...
import requests
import json
from github import cloudflare_api_token, cloudflare_account_id, cloudflare_zone_id
...
cloudflare = Cloudflare(cloudflare_api_token,cloudflare_api_token,cloudflare_zone_id)
